...
public class YikondiAppliKafkaResourceIT {
    ...
    @Autowired
    private YikondiAppliKafkaProducer producer;

    @Autowired
    private YikondiAppliKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        YikondiAppliKafkaResource kafkaResource = new YikondiAppliKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/yikondi-appli-kafka/publish?message=test"))
