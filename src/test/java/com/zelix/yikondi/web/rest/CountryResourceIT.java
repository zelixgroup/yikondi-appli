...
public class CountryResourceIT {
    ...
    private static final String DEFAULT_PHONE_REFERENCE_NUMBER = "AAAAAAAAAA";
    private static final String UPDATED_PHONE_REFERENCE_NUMBER = "BBBBBBBBBB";
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country()
            ...
            .name(DEFAULT_NAME)
            .phoneReferenceNumber(DEFAULT_PHONE_REFERENCE_NUMBER);
        return country;
    }
    /**
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country()
            ...
            .name(UPDATED_NAME)
            .phoneReferenceNumber(UPDATED_PHONE_REFERENCE_NUMBER);
        return country;
    }
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getPhoneReferenceNumber()).isEqualTo(DEFAULT_PHONE_REFERENCE_NUMBER);
    }
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].phoneReferenceNumber").value(hasItem(DEFAULT_PHONE_REFERENCE_NUMBER)));
    }
    ...
    public void getCountry() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries/{id}", country.getId()))
            ...
            .andExpect(jsonPath("$.phoneReferenceNumber").value(DEFAULT_PHONE_REFERENCE_NUMBER));
    }
    ...
    public void updateCountry() throws Exception {
        ...
        assertThat(testCountry.getPhoneReferenceNumber()).isEqualTo(UPDATED_PHONE_REFERENCE_NUMBER);
    }
